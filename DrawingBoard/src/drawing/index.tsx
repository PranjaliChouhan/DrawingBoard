...
const Drawing = () => {
  ...
  const canvas = useRef<any>(null); // Use "any" temporarily to address the error
  ...
  const onDrawCallback = useDrawCallback((_canvas, info) => {
    ...
    <SafeAreaView
      ...
      <View
        ...
        <View
          ...
          {/* Remove the Canvas element for now, as it is causing the error */}
          {/* <Canvas
            style={{
              height: canvasHeight,
              width: width - 24,
